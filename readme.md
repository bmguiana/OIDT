...
The circuit synthesis portion is currently only available with GPU-based S-parameter extraction. Updates to CPU-based S-parameter extraction are coming soon.
