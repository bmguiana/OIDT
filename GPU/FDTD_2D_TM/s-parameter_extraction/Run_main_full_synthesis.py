...
import sys
import pickle
from aux_funcs import dict_from_module
...
TL = Network('./{}/{}.s{}p'.format(usr['output_dir'], usr['sparam_file'], 2*usr['num_lines']))
...
#-----------------------------------------------------------------------Genrate netlist------------------------------------------------------------------
create_netlist_file(poles, residues, number_of_ports, out_file_path='./{}/{}.sp'.format(usr['output_dir'], usr['spice_file']))
