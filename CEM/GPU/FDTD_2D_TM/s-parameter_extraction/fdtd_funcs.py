...
def generate_fg_mask(num_x, num_y, bord_x, bord_y, wg_height, pitch, num_lines, settling_range, end_range, rough_std, rough_acl, dx, mode='gen', correlation=3, upper_name='', lower_name='', atol=0.1, stol=0.1, mtol=0.01):
