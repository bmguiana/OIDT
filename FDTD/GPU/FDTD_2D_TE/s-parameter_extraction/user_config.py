...
sparam_file = 'check_func'     # Output file name for S-Parameter extraction (, str)

# S-Parameter Extraction
sparam_fmin = 100e12           # Minimum frequency for S-Parameter output file (Hz, float)
sparam_fmax = 300e12           # Maximum frequency for S-Parameter output file (Hz, float)
sparam_num_freqs = 101         # Number of frequencies between fmin and fmax, inclusive (, int)
